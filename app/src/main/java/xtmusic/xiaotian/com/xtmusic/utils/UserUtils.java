package xtmusic.xiaotian.com.xtmusic.utils;
...
public class UserUtils {
    ...
    public static boolean validateLogin(Context context, String phone, String password){
        //RegexUtils.isMobileSimple(phone);//简单的验证   "^[1]\\d{10}$"
        //RegexUtils.isMobileExact(phone);//精确的验证    "^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(16[6])|(17[0,1,3,5-8])|(18[0-9])|(19[8,9]))\\d{8}$"
        if (!RegexUtils.isMobileExact(phone)){
            Toast.makeText(context,"手机号无效",Toast.LENGTH_LONG).show();
            return false;
        }
